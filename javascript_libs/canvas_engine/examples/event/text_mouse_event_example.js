...
const mouseUpText = Sprite2D.createFromText(`${mouseUpTextString}-${mouseUpTextCount}`).addMouseUpEvent(() => {
...
const mouseMoveText = Sprite2D.createFromText(`${mouseMoveTextString}-${mouseMoveTextCount}`).addMouseMoveEvent(() => {
...
const mouseEnterText = Sprite2D.createFromText(`${mouseEnterTextString}-${mouseEnterTextCount}`).addMouseEnterEvent(
	() => {
...
const mouseLeaveText = Sprite2D.createFromText(`${mouseLeaveTextString}-${mouseLeaveTextCount}`).addMouseLeaveEvent(
	() => {
...
const mouseDragText = Sprite2D.createFromText(`${mouseDragTextString}-${mouseDragTextCount}`).addDragStartEvent(() => {
