...
export class CubeTexture extends BaseTexture {
     ...
     */
    constructor(rootUrl, sceneOrEngine, extensionsOrOptions = null, noMipmap = false, files = null, onLoad = null, onError = null, format = 5, prefiltered = false, forcedExtension = null, createPolynomials = false, lodScale = 0.8, lodOffset = 0, loaderOptions, useSRGBBuffer) {
        super(sceneOrEngine);
        this._lodScale = 0.8;
        this._lodOffset = 0;
        /**
