 ...
 */
const loadImage = codeMarkFunction(function (url) {
	let {
		signal,
		crossOrigin = null
 ...
 */
const enlivenObjects = codeMarkFunction(function (objects) {
	let {
		signal,
		reviver = noop
	} = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
 ...
 */
const enlivenObjectEnlivables = codeMarkFunction(function (serializedObject) {
	let {
		signal
	} = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	return new Promise((resolve, reject) => {
