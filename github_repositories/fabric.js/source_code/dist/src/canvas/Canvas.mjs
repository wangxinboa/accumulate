...
const getEventPoints = codeMarkFunction((canvas, e) => {
...
const addListener = codeMarkFunction(function (el) {
	for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
		args[_key - 1] = arguments[_key];
	}
	return el.addEventListener(...args);
}, 'addListener');
const removeListener = codeMarkFunction(function (el) {
...
const Canvas = codeMarkClass(class Canvas extends SelectableCanvas {
	constructor(el) {
