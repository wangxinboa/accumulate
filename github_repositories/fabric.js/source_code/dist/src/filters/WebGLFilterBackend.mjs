...
const WebGLFilterBackend = codeMarkClass(class WebGLFilterBackend {
	constructor() {
		let {
...
const resizeCanvasIfNeeded = codeMarkFunction(function resizeCanvasIfNeeded(pipelineState) {
	const targetCanvas = pipelineState.targetCanvas,
