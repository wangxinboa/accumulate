...
export var WildEvolutionRate;
(function (WildEvolutionRate) {
	WildEvolutionRate[WildEvolutionRate["NORMAL"] = 0] = "NORMAL";
	WildEvolutionRate[WildEvolutionRate["UNCOMMON"] = 1] = "UNCOMMON";
	WildEvolutionRate[WildEvolutionRate["RARE"] = 2] = "RARE";
	WildEvolutionRate[WildEvolutionRate["ULTRA_RARE"] = 3] = "ULTRA_RARE";
	WildEvolutionRate[WildEvolutionRate["TAG_NONE"] = 4] = "TAG_NONE";
})(WildEvolutionRate || (WildEvolutionRate = {}));

export class PokemonSpeciesEvolution {
	constructor(speciesId, level, item, condition, wildRate) {
...
export class PokemonSpeciesEvolutionCondition {
	constructor(predicate, applyToWild) {
...
export const pokemonEvolutions = {
	...
	[Species.TYROGUE]: [
		new PokemonSpeciesEvolution(Species.HITMONLEE, 20, null, new PokemonSpeciesEvolutionCondition((p) => p.stats[Stat.ATK] > p.stats[Stat.DEF])),
		new PokemonSpeciesEvolution(Species.HITMONCHAN, 20, null, new PokemonSpeciesEvolutionCondition((p) => p.stats[Stat.ATK] < p.stats[Stat.DEF])),
		new PokemonSpeciesEvolution(Species.HITMONTOP, 20, null, new PokemonSpeciesEvolutionCondition((p) => p.stats[Stat.ATK] === p.stats[Stat.DEF]))
	],
	[Species.KOFFING]: [
	...
	[Species.KIRLIA]: [
		...
		new PokemonSpeciesEvolution(Species.GALLADE, 1, "Dawn Stone", new PokemonSpeciesEvolutionCondition((p) => p.gender, true), WildEvolutionRate.RARE)
	],
	[Species.SURSKIT]: [
	...
	[Species.SNORUNT]: [
		...
		new PokemonSpeciesEvolution(Species.FROSLASS, 1, "Dawn Stone", new PokemonSpeciesEvolutionCondition((p) => !p.gender, true), WildEvolutionRate.RARE)
	],
	[Species.SPHEAL]: [
	...
	[Species.BURMY]: [
		new PokemonSpeciesEvolution(Species.MOTHIM, 20, null, new PokemonSpeciesEvolutionCondition((p) => p.gender, true)),
		new PokemonSpeciesEvolution(Species.WORMADAM, 20, null, new PokemonSpeciesEvolutionCondition((p) => !p.gender /* && grass*/, true)),
		new PokemonSpeciesEvolution(Species.WORMADAM, 20, null, new PokemonSpeciesEvolutionCondition((p) => !p.gender /* && cave*/, true)),
		new PokemonSpeciesEvolution(Species.WORMADAM, 20, null, new PokemonSpeciesEvolutionCondition((p) => !p.gender /* && building*/, true))
	],
	[Species.COMBEE]: [
		new PokemonSpeciesEvolution(Species.VESPIQUEN, 21, null, new PokemonSpeciesEvolutionCondition((p) => !p.gender, true))
	],
	[Species.BUIZEL]: [
	...
	[Species.POLIWHIRL]: [
		...
		new PokemonSpeciesEvolution(Species.POLITOED, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* King's rock*/), WildEvolutionRate.RARE)
	],
	[Species.WEEPINBELL]: [
	...
	[Species.EEVEE]: [
		new PokemonSpeciesEvolution(Species.ESPEON, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10 /* daytime */), WildEvolutionRate.RARE),
		new PokemonSpeciesEvolution(Species.UMBREON, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10 /* nighttime */), WildEvolutionRate.RARE),
	...
	[Species.SLOWPOKE]: [
		new PokemonSpeciesEvolution(Species.SLOWKING, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* King's rock*/), WildEvolutionRate.RARE)
	],
	[Species.HAUNTER]: [
		new PokemonSpeciesEvolution(Species.GENGAR, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true), WildEvolutionRate.UNCOMMON)
	],
	[Species.ONIX]: [
		new PokemonSpeciesEvolution(Species.STEELIX, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Metal coat*/), WildEvolutionRate.RARE)
	],
	[Species.RHYDON]: [
		new PokemonSpeciesEvolution(Species.RHYPERIOR, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Protector */), WildEvolutionRate.RARE)
	],
	[Species.SEADRA]: [
		new PokemonSpeciesEvolution(Species.KINGDRA, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Dragon scale*/), WildEvolutionRate.RARE)
	],
	[Species.SCYTHER]: [
		new PokemonSpeciesEvolution(Species.SCIZOR, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Metal coat*/), WildEvolutionRate.UNCOMMON)
	],
	[Species.ELECTABUZZ]: [
		new PokemonSpeciesEvolution(Species.ELECTIVIRE, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Electirizer*/), WildEvolutionRate.UNCOMMON)
	],
	[Species.MAGMAR]: [
		new PokemonSpeciesEvolution(Species.MAGMORTAR, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Magmarizer*/), WildEvolutionRate.UNCOMMON)
	],
	[Species.PORYGON]: [
		new PokemonSpeciesEvolution(Species.PORYGON2, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /*Upgrade*/), WildEvolutionRate.RARE)
	],
	[Species.PORYGON2]: [
		new PokemonSpeciesEvolution(Species.PORYGON_Z, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Dubious disc*/), WildEvolutionRate.ULTRA_RARE)
	],
	[Species.FEEBAS]: [
		new PokemonSpeciesEvolution(Species.MILOTIC, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Prism scale*/), WildEvolutionRate.ULTRA_RARE)
	],
	[Species.DUSCLOPS]: [
		new PokemonSpeciesEvolution(Species.DUSKNOIR, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Reaper cloth*/), WildEvolutionRate.RARE)
	],
	[Species.CLAMPERL]: [
		new PokemonSpeciesEvolution(Species.HUNTAIL, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Deep sea tooth*/), WildEvolutionRate.RARE),
		new PokemonSpeciesEvolution(Species.GOREBYSS, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Deep sea scale*/), WildEvolutionRate.RARE)
	],
	[Species.BOLDORE]: [
	...
	[Species.KARRABLAST]: [
		new PokemonSpeciesEvolution(Species.ESCAVALIER, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Trade with shelmet??*/), WildEvolutionRate.RARE)
	],
	[Species.SHELMET]: [
		new PokemonSpeciesEvolution(Species.ACCELGOR, 1, "Link Cable", new PokemonSpeciesEvolutionCondition((p) => true /* Trade with karrablast??*/), WildEvolutionRate.RARE)
	],
	[Species.PICHU]: [
		new PokemonSpeciesEvolution(Species.PIKACHU, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.CLEFFA]: [
		new PokemonSpeciesEvolution(Species.CLEFAIRY, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.IGGLYBUFF]: [
		new PokemonSpeciesEvolution(Species.JIGGLYPUFF, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.GOLBAT]: [
		new PokemonSpeciesEvolution(Species.CROBAT, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.CHANSEY]: [
		new PokemonSpeciesEvolution(Species.BLISSEY, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.MUNCHLAX]: [
		new PokemonSpeciesEvolution(Species.SNORLAX, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.TOGEPI]: [
		new PokemonSpeciesEvolution(Species.TOGETIC, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.AZURILL]: [
		new PokemonSpeciesEvolution(Species.MARILL, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.BUDEW]: [
		new PokemonSpeciesEvolution(Species.ROSELIA, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount > 10 /* daytime */))
	],
	[Species.CHINGLING]: [
		new PokemonSpeciesEvolution(Species.CHIMECHO, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10 /* nighttime */))
	],
	[Species.BUNEARY]: [
		new PokemonSpeciesEvolution(Species.LOPUNNY, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.RIOLU]: [
		new PokemonSpeciesEvolution(Species.LUCARIO, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10 /* daytime */))
	],
	[Species.WOOBAT]: [
		new PokemonSpeciesEvolution(Species.SWOOBAT, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	],
	[Species.SWADLOON]: [
		new PokemonSpeciesEvolution(Species.LEAVANNY, 1, null, new PokemonSpeciesEvolutionCondition((p) => p.winCount >= 10))
	]
}