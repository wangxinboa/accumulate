...
var bg = PIXI.Sprite.fromImage("./demos/15.Filters/depth_blur_BG.jpg");
stage.addChild(bg);

var littleDudes = PIXI.Sprite.fromImage("./demos/15.Filters/depth_blur_dudes.jpg");
littleDudes.position.y = 100;
stage.addChild(littleDudes);

var littleRobot = PIXI.Sprite.fromImage("./demos/15.Filters/depth_blur_moby.jpg");
