...
var bg = PIXI.Sprite.fromImage("./demos/15.Filters/displacement_BG.jpg");
...
for (var i = 0; i < 20; i++) {
	...
	var fish = PIXI.Sprite.fromImage("./demos/15.Filters/displacement_fish" + fishId + ".png");
...
var overlay = new PIXI.TilingSprite(PIXI.Texture.fromImage("./demos/15.Filters/zeldaWaves.png"), 630, 410);
overlay.alpha = 0.2;
pondContainer.addChild(overlay);


var displacementTexture = PIXI.Texture.fromImage("./demos/15.Filters/displacement_map.jpg");
