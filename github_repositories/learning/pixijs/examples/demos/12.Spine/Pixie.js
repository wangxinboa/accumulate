...
function onAssetsLoaded() {
	background = PIXI.Sprite.fromImage("./demos/12.Spine/data/iP4_BGtile.jpg");
	background2 = PIXI.Sprite.fromImage("./demos/12.Spine/data/iP4_BGtile.jpg");
	stage.addChild(background);
	stage.addChild(background2);

	foreground = PIXI.Sprite.fromImage("./demos/12.Spine/data/iP4_ground.png");
	foreground2 = PIXI.Sprite.fromImage("./demos/12.Spine/data/iP4_ground.png");
