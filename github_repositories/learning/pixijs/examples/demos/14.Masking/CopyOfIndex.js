...
var bg = PIXI.Sprite.fromImage("./demos/14.Masking/BGrotate.jpg");
bg.anchor.x = 0.5;
bg.anchor.y = 0.5;
...
var light2 = PIXI.Sprite.fromImage("./demos/14.Masking/LightRotate2.png");
light2.anchor.x = 0.5;
light2.anchor.y = 0.5;
container.addChild(light2);

var light1 = PIXI.Sprite.fromImage("./demos/14.Masking/LightRotate1.png");
light1.anchor.x = 0.5;
light1.anchor.y = 0.5;
container.addChild(light1);

var panda = PIXI.Sprite.fromImage("./demos/14.Masking/panda.png");
panda.anchor.x = 0.5;
panda.anchor.y = 0.5;
