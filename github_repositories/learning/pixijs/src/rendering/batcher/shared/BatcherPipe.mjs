...
const _BatcherPipe = class _BatcherPipe {
	/** @type {Record<string, PixijsType.DefaultBatcher>} */
	batchers;
	/** @type {Record<string, PixijsType.DefaultBatcher>} */
	_activeBatches;
	/** @type {PixijsType.DefaultBatcher} */
	_activeBatch;
	/** @type {Record<string, Record<string, PixijsType.DefaultBatcher>>} */
	_batchersByInstructionSet;
	/**
	 * @param {PixijsType.Renderer} renderer
	 * @param {PixijsType.GlBatchAdaptor} adaptor
	 */
	...
	/**
	 * @param {PixijsType.InstructionSet} instructionSet
	 */
	...
	/**
	 *
	 * @param {PixijsType.BatchableSprite} batchableObject
	 * @param {PixijsType.InstructionSet} instructionSet
	 */
