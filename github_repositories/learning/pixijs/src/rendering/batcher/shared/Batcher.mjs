...
const _Batcher = class _Batcher {
	/** @type {Array<PixijsType.BatchableSprite>} */
	_elements;
	/** @type {number} */
	elementSize;
	/** @type {number} */
	...
	/** @type {number} */
	vertexSize;
	/** @type {PixijsType.ViewableBuffer} */
	attributeBuffer;
	/**
	 *
	 * @param {PixijsType.BatcherInitOption} options
	 */
	constructor(options = {}) {
	 ...
	 * @param {PixijsType.BatchTextureArray} textureBatch
