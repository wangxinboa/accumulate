...
class GlBatchAdaptor {
	...
	/**
	 * @param {PixijsType.BatcherPipe} batcherPipe
	 */
	init(batcherPipe) {
	...
	/**
	 *
	 * @param {PixijsType.BatcherPipe} batchPipe
	 * @param {PixijsType.BatchGeometry} geometry
	 * @param {PixijsType.DefaultShader} shader
	 */
