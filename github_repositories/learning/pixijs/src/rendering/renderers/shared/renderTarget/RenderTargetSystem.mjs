...
class RenderTargetSystem {
	/** @type {PixijsType.GlRenderTargetAdaptor} */
	adaptor;
	/** @type {Array<{ renderTarget: PixijsType.RenderTarget; frame: Rectangle }>} */
	_renderTargetStack;
	/** @type {PixijsType.RenderTarget}  */
	renderTarget;
	/**
	 * @param {PixijsType.Renderer} renderer
	 */
	 ...
	 * @param {PixijsType.RenderTargetSystemRenderStartOption} options
	 */
	 ...
	 * @param {PixijsType.RenderTargetSystemRenderStartOption["target"]} renderSurface - the render surface to bind
	 * @param clear - the clear mode to use. Can be true or a CLEAR number 'COLOR | DEPTH | STENCIL' 0b111
	 * @param {PixijsType.RenderTargetSystemRenderStartOption["clearColor"]} clearColor - the color to clear to
	 * @param {PixijsType.RenderTargetSystemRenderStartOption["frame"]} frame - the frame to render to
