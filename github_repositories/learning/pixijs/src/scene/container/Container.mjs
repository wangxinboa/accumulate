...
class Container extends EventEmitter {
	/** @type {PixijsType.RenderGroup | null} */
	renderGroup;
	/** @type {PixijsType.RenderGroup | null} */
	parentRenderGroup;
	/** @type {PixijsType.Matrix} */
	groupTransform;
	/** @type {Array<PixijsType.AllContainer>} */
	children;

	collectRenderablesWithEffects = collectRenderablesMixin["collectRenderablesWithEffects"];
