...
import StencilManager from './managers/StencilManager.js';
import FilterManager from './managers/FilterManager.js';
import BlendModeManager from './managers/BlendModeManager.js';
import RenderTarget from './utils/RenderTarget.js';
import ObjectRenderer from './utils/ObjectRenderer.js';
import FXAAFilter from './filters/FXAAFilter.js';
 ...
 */
export default function WebGLRenderer(width, height, options) {
	options = options || {};
