...
import { WRAP_MODES } from '../../core/const.js';
// import { readFileSync } from 'fs';
// import { join } from 'path';

import tilingSprite_simpleFrag from './tilingSprite_simple.frag.js';
import tilingSpriteVert from './tilingSprite.vert.js';
import tilingSpriteFrag from './tilingSprite.frag.js';
...
export default class TilingSpriteRenderer extends core.ObjectRenderer {
	...
	constructor(renderer) {
		...
		this.simpleShader = core.Shader.from(
			// readFileSync(join(__dirname, './tilingSprite.vert'), 'utf8'),
			// readFileSync(join(__dirname, './tilingSprite_simple.frag'), 'utf8'),
			tilingSpriteVert,
			tilingSprite_simpleFrag,
			uniforms);
