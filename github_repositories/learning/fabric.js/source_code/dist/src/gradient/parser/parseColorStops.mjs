...
const parseColorStop = codeMarkFunction(function parseColorStop(el, multiplier) {
...
const parseColorStops = codeMarkFunction(function parseColorStops(el, opacityAttr) {
	const colorStops = [],
