 ...
 */
const NoopLayoutManager = codeMarkClass(class NoopLayoutManager extends LayoutManager {
	performLayout() { }
})
 ...
 * @fires layout:after
 */
const Group = codeMarkClass(class Group extends createCollectionMixin(FabricObject) {
	static getDefaults() {
