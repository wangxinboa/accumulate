...
const createSVGInlineRect = codeMarkFunction(function createSVGInlineRect(color, left, top, width, height) {
...
const TextSVGExportMixin = codeMarkClass(class TextSVGExportMixin extends FabricObjectSVGExportMixin {
	_toSVG() {
