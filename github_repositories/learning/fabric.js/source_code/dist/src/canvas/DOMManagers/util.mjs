...
const setCanvasDimensions = codeMarkFunction(function (el, ctx, _ref) {
	let {
		width,
		height
	} = _ref;
...
const setCSSDimensions = codeMarkFunction((el, _ref2) => {
	let {
		width,
		height
	} = _ref2;
 ...
 */
const getElementOffset = codeMarkFunction(function getElementOffset(element) {
 ...
 */
const makeElementUnselectable = codeMarkFunction(function makeElementUnselectable(element) {
