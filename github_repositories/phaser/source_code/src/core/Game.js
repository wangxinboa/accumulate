...
var Game = new Class({
    ...
    function Game (config)
    {
        ...
        console.group('%cGame 初始化属性', 'font-size: 16px; color: #ffffff; background-color: #000000;');
        /**
        ...
        console.info('Game this.config:', this.config);
    ...
    boot: function ()
    {
        console.group('%cGame boot', 'font-size: 16px; color: #ffffff; background-color: #000000;');
        ...
        console.info('Game boot 添加 this.canvas 到 this.config.parent 中');
        ...
        console.group('%cGame boot this.events.emit(Events.BOOT);', 'font-size: 14px; color: #ffffff; background-color: #000000;');
